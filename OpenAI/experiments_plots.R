...
# models
models <- c("GPT-3", "InstructGPT", "GPT-3.5", "GPT-4")
...
to.plot$Model <- ordered(to.plot$Model, levels =  c("GPT-3", "InstructGPT", "GPT-3.5", "GPT-4", "Humans"))

jpeg("overall_plot_openai.jpeg", width = 800, height = 800)
